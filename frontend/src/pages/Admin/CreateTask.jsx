        ...
        <div className='grid grid-cols-1 md:grid-cols-4 mt-4'>
          <div className='form-card col-span-3'>
            ...
            <div className='mt-3'>
              ...
              <textarea placeholder='Describe Task' className='form-input' rows={4}
            ...
            <div className="mt-8 flex gap-4">
              ...
              <button
                ...
                disabled={loading}
                className="flex-1 py-3 text-sm font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition duration-200 shadow-md cursor-pointer disabled:opacity-50"
              >
